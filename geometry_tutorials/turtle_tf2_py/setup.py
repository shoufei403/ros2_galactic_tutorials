...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'turtle_tf2_listener_timeout = turtle_tf2_py.turtle_tf2_listener_timeout:main',
            'turtle_tf2_listener_time_travel = turtle_tf2_py.turtle_tf2_listener_time_travel:main',
